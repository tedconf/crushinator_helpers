module CrushinatorHelpers
  module ViewHelpers
    ...
    def crushinate(url, options={})
      ...
      if url.match(/(filepicker|tedcdn|(images|storage|tedlive|tedlive-staging|ted2017|ted2017-staging|tedcdnp(e|f)-a)\.ted|(s3|s3-us-west-2)\.amazonaws|\.akamaihd)\.(io|com|net)/)
        url = url.gsub(/.*\/\//, '')
